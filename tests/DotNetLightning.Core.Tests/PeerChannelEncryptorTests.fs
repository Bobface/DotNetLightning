    ...
    testList "PeerChannelEncryptorTests" [
        testCase "noise initiator test vectors" <| fun _ ->
            ...
            let testCase1() =
                ...
                Expect.isOk (res.ToFSharpCoreResult()) ""
            ...
            let testCase3() =
                ...
                Expect.isError ((outboundPeer |> PeerChannelEncryptor.processActTwo actTwo ourNodeId).ToFSharpCoreResult()) ""
        ...
        testCase "noise responder test vectors" <| fun _ ->
            ...
            let _testCase1 =
                ...
                Expect.isOk (actualR.ToFSharpCoreResult()) ""
                ...
                Expect.isOk (actualRR.ToFSharpCoreResult()) ""
            ...
            let _testCase3 =
                ...
                Expect.isError (actualR.ToFSharpCoreResult()) ""
            ...
            let _testCase5 =
                ...
                Expect.isError (actualRR.ToFSharpCoreResult()) ""
            ...
            let _testCase8 =
                ...
                Expect.isError (r.ToFSharpCoreResult()) ""
        ...
        testCase "message encryption decryption test vectors" <| fun _ ->
            ...
            let rec loop (i: int) (localOutBound) (localInbound) =
                ...
                if i > 1005 then
                    ...
                    Expect.isOk (actualLengthR.ToFSharpCoreResult()) ""
